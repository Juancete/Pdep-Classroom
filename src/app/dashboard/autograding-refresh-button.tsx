...
export function AutogradingRefreshButton({ assignmentId }: { assignmentId: string }) {
  ...
  return (
    <span className="inline-flex items-center gap-1">
      <button
        ...
        disabled={loading}
        title="Actualizar resultado de autograding"
        aria-label="Actualizar resultado de autograding"
