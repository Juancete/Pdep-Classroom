...
describe("HistorialDeMembresias", () => {
  ...
  it("incluye navegación paginada completa", () => {
    ...
    expect(html).toContain('href="/admin/assignments/a1/historial-integrantes?page=1"');
    expect(html).toContain('href="/admin/assignments/a1/historial-integrantes?page=3"');
  });
});
